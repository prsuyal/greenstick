      ...
      <div className="flex flex-col lg:flex-row items-center justify-between text-center lg:text-left">
        <div className="max-w-full">
          ...
          <p className="text-sm mt-2">
            Or,{" "}
            <a href="#" className="text-black font-bold hover:underline" onClick={() => navigate("/register")}>
              click here
            </a>{" "}
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between">
              <div className="text-left lg:w-1/2 pr-8">
                ...
                <p className="mt-4 sm:mt-6 text-lg sm:text-xl md:text-2xl font-[Poppins] font-light">
                  Learn, apply, and learn again.<br />
                  With Greenstick, learning doesn't stop.<br />
                  Even as you grow in expertise.
                </p>
                <button 
                  onClick={() => navigate("/register")}
          ...
          <div className="pt-8 pb-8 text-black">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-center">
              <div className="flex flex-col items-center">
                <img src={data} alt="Real-Time Data" className="h-12 mb-2" />
                <div className="font-[Poppins]">Real-Time Data</div>
              </div>
              <div className="flex flex-col items-center">
              ...
              <div className="flex flex-col items-center">
                <img src={wallet} alt="Portfolio Management" className="h-12 mb-2" />
                <div className="font-[Poppins]">Portfolio Management</div>
              </div>
              <div className="flex flex-col items-center">
              ...
              <div className="flex flex-col items-center">
                <img src={learning} alt="Beginner-Friendly" className="h-12 mb-2" />
                <div className="font-[Poppins]">Beginner-Friendly</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="relative py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 md:grid-cols-3">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-lg font-[Poppins] font-medium text-gray-900">Virtual Assistance</h3>
              <p className="mt-2 text-base text-gs-dark-gray">Get real-time support from Exo, your virtual assistant, ready to answer questions and guide you through complex trading scenarios.</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
